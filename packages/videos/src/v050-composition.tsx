...
// Basement Grotesque Black stacked caps slamming in on hard cuts, marquee
...
// Basement Grotesque Black is basement.studio's own open-source display face:
// https://github.com/basementstudio/basement-grotesque (free for commercial use).
loadFont({
  family: "Basement Grotesque",
  url: staticFile("fonts/BasementGrotesque-Black.woff2"),
  weight: "800",
});

const GROTESQUE = "'Basement Grotesque', 'Arial Black', sans-serif";
...
// never clips: Basement Grotesque caps average ~0.72em per character.
const SAFE_W = 1150;
const CHAR_EM = 0.72;
