...
| :-- | :-- | :-- | :-- |
| [`Dockerfile`](#what-the-comment-shows) | <img className="inline" src="/status/error.svg" alt="Error" /> Error | 1 error, 1 info | Aug 10, 2026 1:11pm |
| [`compose.yml`](#what-the-comment-shows) | <img className="inline" src="/status/clean.svg" alt="Clean" /> Clean | — | Aug 10, 2026 1:11pm |

**Score:** [84 / 100](/share?s=84&w=0&e=1) · <img className="inline" src="/status/good.svg" alt="Good" /> Good

**`Dockerfile`**

- <img className="inline" src="/status/error.svg" alt="error" />
  [`Dockerfile:2`](#what-the-comment-shows) Potential secret found in ENV:
  'DB_PASSWORD'. `no-secrets-in-env`
- <img className="inline" src="/status/info.svg" alt="info" />
  [`Dockerfile:1`](#what-the-comment-shows) No HEALTHCHECK instruction found.
  `require-healthcheck`
...
- The per-file table is sorted worst-first, and every file links to it at the scanned commit.
