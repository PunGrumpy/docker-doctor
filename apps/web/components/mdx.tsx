...
const Heading2 = ({ className, children, ...props }: ComponentProps<"h2">) => (
  <h2
    className={cn(
...
const Heading3 = ({ className, children, ...props }: ComponentProps<"h3">) => (
  <h3
    className={cn(
...
const TableHeaderCell = ({ className, ...props }: ComponentProps<"th">) => (
  <th
    className={cn(
...
const Card = ({ icon, title, href, children }: CardProps) => {
  const content = (
    <>
      {icon ? (
...
const Cards = ({ children }: { readonly children: ReactNode }) => (
