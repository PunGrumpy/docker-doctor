...
import { ClaudeMessage } from "@/components/claude/claude-message";
import { ClaudePermission } from "@/components/claude/claude-permission";
import { ClaudePrompt } from "@/components/claude/claude-prompt";
...
import { ClaudeToolCall } from "@/components/claude/claude-tool-call";
...
export const ClaudeSession = () => (
  <div className="space-y-3 font-mono text-[13px] leading-[1.6] text-[#c0caf5]">
    ...
    <div className="space-y-3 pt-1">
      <ClaudeMessage messageRole="user">
      ...
      <ClaudeToolCall
        tool="Read"
        arg="app/settings/page.tsx"
        result="Read 48 lines"
      />
      ...
      <ClaudeDiff
        ...
        lines={[
          { n: 11, text: "export function Settings() {", type: "ctx" },
          { n: 12, text: "  return <Panel>{sections}</Panel>", type: "del" },
          { n: 12, text: "  return (", type: "add" },
          {
            n: 13,
            text: "    <Panel header={<ThemeToggle />}>",
            type: "add",
          },
          { n: 14, text: "      {sections}", type: "add" },
          { n: 15, text: "    </Panel>", type: "ctx" },
        ]}
      />
