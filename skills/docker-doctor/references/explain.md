...
The config also accepts an `ignore.files` array of glob patterns. docker-doctor drops matching files from discovery before any rule runs. The decision guide below covers when to use it.
